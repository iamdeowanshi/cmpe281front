...
app.post('/addEmployee', function(req, res) {
  ...
  axios.post('http://54.67.33.0:443/employee', {
        FirstName: Firstname,
        LastName: LastName,
        Gender: Gender,
        Age: Age,
...
app.post('/deleteEmployee', function(req, res) {
  ...
  axios.delete('http://54.67.33.0:443/employee/delete/'+ID)
    .then(function(response) {
...
function EmployeeReport() {
  ...
  axios.get('http://54.67.33.0:443/employees')
    .then(function (response) {
...
function searchEmployee() {
  ...
  $('#search_employee_button').on('click', function() { 
    var ID = $('#search_employee_field').val()
     ...
     axios.get('http://54.67.33.0:443/employee/'+ID)
    .then(function(response) {
...
function showPayment() {
  ...
  axios.get('http://18.205.192.131:443/payment/' + userID)
    .then(function (response) {
      for (var i = 0; i < response.data.length; i ++) {
