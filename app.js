...
app.post('/addEmployee', function(req, res) {
  ...
  axios.post('https://54.67.33.0:80/employee', {
        FirstName: Firstname,
        LastName: LastName,
        Gender: Gender,
        Age: Age,
...
app.post('/deleteEmployee', function(req, res) {
  ...
  axios.delete('https://54.67.33.0:80/employee/delete/'+ID)
    .then(function(response) {
...
app.post('/payment', function(req, res) {
  ...
  axios.post('https://18.205.192.131:443/payment', {
        OrderId: OrderID,
...
function EmployeeReport() {
  ...
  axios.get('https://54.67.33.0:443/employees')
    .then(function (response) {
...
function searchEmployee() {
  ...
  $('#search_employee_button').on('click', function() { 
    var ID = $('#search_employee_field').val()
     ...
     axios.get('https://54.67.33.0:443/employee/'+ID)
    .then(function(response) {
...
function showPayment() {
  ...
  axios.get('https://18.205.192.131:443/payment/' + userID)
    .then(function (response) {
      for (var i = 0; i < response.data.length; i ++) {
